    ...
    <div class="container-fluid">
        ...
        <div class="row mt-3">
            <div class="col-lg-6">
                <div class="card">
                    <div class="card-body">
                        <div class="card-title"><?php echo _('OTWI Settings'); ?></div>
                        <hr>
        ...
        <div class="card">
           ...
           <div class="form-group">
               <label>Update Server: <?php $online = @fsockopen("updates.opensim-tools.de", 80); if($online) { echo '<strong style="color: lime;">OTWI Updateserver erreichbar</strong>'; } else { echo '<strong style="color: red;">OTWI Updateserver Störung</strong>';} ?></label>
           </div>
         </div>
         </div>
      </div>
